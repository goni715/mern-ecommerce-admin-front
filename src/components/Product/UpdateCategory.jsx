...
import {selectCategoryName} from "../../redux/state-slice/productCategorySlice";
import {GetProductCategoryRequest, UpdateCategoryRequest} from "../../ApiServices/ProductCategoryApiRequest";
...
const UpdateBrand = ({id}) => {
    ...
    useEffect(()=>{
        (async () => {
            await GetProductCategoryRequest(id);
        })();
    },[id])
    ...
    const SaveChange = async () => {
        ...
        if(IsEmpty(categoryName)){
            ...
            let result = await UpdateCategoryRequest(categoryName,id);
    ...
    return (
        <>
            ...
            <div className="container-fluid">
                <h3 className="title">Update Product Category</h3>
                <div className="row">
